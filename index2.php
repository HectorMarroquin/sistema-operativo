...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="css/StyleDesktop.css">
	  ...
	  <script type="text/javascript" src="js/buscarnotas.js"></script>
	  <script type="text/javascript" src="js/Editortxt.js"></script>
  ...
  <body onload="init();">
	  ...
	  <div id="buscador">
		...
		<p>Sugerencía: <span id="resultadoBusqueda"></span></p>
	  ...
	  <div id="barra">
		  ...
		  <input type="text" class="buscar" name="buscar" id="buscar" onkeyup="buscar();" placeholder="Buscar Notas"> 
...
<div id="div105">
		<input type="text" name="buscar" id="buscarTxt" placeholder="Archivo a buscar" class="inp"><br>
	<div id="txtHint">
	</div>
	<input type="text" placeholder="Nombre Del Archivo" id="nombre" class="inp">
	<input type="text" name="eliminararchivo" placeholder="Eliminar" id="eliminararchivo" class="inp">
</div>
